...
% MARK - Unfortunately your changes meant this didn't run as it did before on continuous data - pls can you fix this, or make a new function? 
...
%         plot(ts,0.8*FO + s - 0.4,'color',col(s,:),'LineWidth',2);
