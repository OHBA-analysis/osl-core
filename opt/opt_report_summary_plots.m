...
try        
    ...
    if isfield(opt.results,'badchans_pre_sss') && ~isnan(opt.results.badchans_pre_sss)              
    ...
    if isfield(opt.results,'autobadoff') && ~isnan(opt.results.autobadoff)            
    ...
    if isfield(opt.results,'icsremoved') && ~isnan(opt.results.icsremoved)                      
