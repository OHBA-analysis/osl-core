...
%%
% Here we first manually build the design matrices we need by using |D.conditions|
...
%%
% We now plot the design matrix alongside the trial timings for a sanity check
...
%%
% We can then set |design_matrix_summary| in |oat.first_level|
