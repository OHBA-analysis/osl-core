...
data = {'s01_rest1.mat','s01_rest2.mat','s02_rest1.mat',...
        's02_rest2.mat','s03_rest1.mat','s03_rest2.mat',...
        's04_rest1.mat','s04_rest2.mat','s05_rest1.mat',...
        's05_rest2.mat','s06_rest1.mat','s06_rest2.mat'};
data = fullfile(data_dir,'data',data);
...
osleyes(GLEAN.results.pcorr.parcel.sessionmaps{1})
