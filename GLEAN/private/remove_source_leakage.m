...
switch protocol
    case 'none'
        ...
        nodeData = demean(nodeDataOrig, 2);
    ...
    case 'closest'
        ...
        orthogFunctionHandle = @ closest_orthogonal_matrix;
    ...
    case 'symmetric'
        ...
        orthogFunctionHandle = @ symmetric_orthogonalise;
...
nParcels = rows(nodeDataOrig);

try
    fprintf('    Orthogonalising...\n');
    nodeData = transpose(demean(orthogFunction(transpose( ...
                                demean(nodeDataOrig, 2)))));   
...
nodeData = householder_orthogonalise(...
                 demean(nodeDataOrig(permutation,:), 2)')'; 
nodeData = demean(nodeData(permutationInverse,:),    2);
