function newNames = add_fname_prefix(oldNames, prefix)
%ADD_FNAME_PREFIX  prefixes a character onto a set of filenames. 
% NEW = ADD_FNAME_PREFIX(OLD, PRE) adds prefix PRE to filename OLD to make
