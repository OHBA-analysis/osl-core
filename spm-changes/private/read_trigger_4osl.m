...
fixoxfordneuromag = keyval('fixoxfordneuromag', varargin); if isempty(fixoxfordneuromag), fixoxfordneuromag = 0;  end % MWW OSL1.1
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MWW added for osl2 (Nov 2014)
if ~isempty(fixoxfordneuromag),
    % First take care of line 16, (line 16 is
    % a special case at it corresponds to -2^15 due to the use of an
    % unsigned 16 bit short):
    dat(dat<0) = dat(dat<0)+2^16;    
    
    binary_mask=fixoxfordneuromag;
    dat=bitand(dat,bin2dec(binary_mask));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
