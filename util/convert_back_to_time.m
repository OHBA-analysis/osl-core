...
% Nsamples=109;yo=demean(randn(Nsamples,1)); NumUniquePts=ceil((Nsamples+1)/2); freq_indtest=2:25; fyo=fft(yo); fyo=fyo(freq_indtest);  y=convert_back_to_time(fyo,Nsamples, freq_indtest); sfigure;plot(y);ho;plot(yo,'r--')
